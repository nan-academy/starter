...
exports$11 = chunkedSplice;
var _chunkedSplice = exports$11;
var exports8 = {
};
var chunkedSplice1 = _chunkedSplice;
function chunkedPush(list, items) {
    if (list.length) {
        chunkedSplice1(list, list.length, 0, items);
        return list;
    }
    return items;
}
exports8 = chunkedPush;
var _chunkedPush = exports8;
var exports9 = {
};
...
function constructs(list, existing) {
    ...
    chunkedSplice2(existing, 0, 0, before);
    return existing;
}
exports$12 = combineExtensions;
var _combineExtensions = exports$12;
var exports10 = {
};
...
exports10 = regexCheck;
var _regexCheck = exports10;
var exports11 = {
};
var regexCheck1 = _regexCheck;
var asciiAlphanumeric = regexCheck1(/[\dA-Za-z]/);
exports11 = asciiAlphanumeric;
var _asciiAlphanumeric = exports11;
var exports12 = {
};
function markdownLineEnding(code) {
    return code < -2;
}
exports12 = markdownLineEnding;
var _markdownLineEnding = exports12;
var exports13 = {
};
...
exports14 = spaceFactory;
var _factorySpace = exports14;
var exports15 = {
};
...
exports15 = partialBlankLine;
var _partialBlankLine = exports15;
var exports16 = {
};
...
exports16 = sizeChunks;
var _sizeChunks = exports16;
var exports$13 = {
};
    ...
    while((++index) < events.length){
        ...
        if (event[0] === "enter") {
            if (event[1].contentType) {
                assign2(jumps, subcontent(events, index));
                index = jumps[index];
                more = true;
            }
            ...
            if (lineIndex) {
                ...
                chunkedSplice3(events, lineIndex, index - lineIndex + 1, parameters);
            }
        }
    }
    return !more;
...
function subcontent(events, eventIndex) {
    ...
    function add(slice) {
        ...
        chunkedSplice3(events, start, 2, slice);
    }
}
exports18 = subtokenize;
var _subtokenize = exports18;
var exports19 = {
};
...
exports19 = resolveAll;
var _resolveAll = exports19;
var exports20 = {
};
function markdownLineEndingOrSpace(code) {
    return code < 0 || code === 32;
}
exports20 = markdownLineEndingOrSpace;
var _markdownLineEndingOrSpace = exports20;
var exports21 = {
};
var unicodePunctuation = /[!-\/:-@\[-`\{-~\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061E\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u09FD\u0A76\u0AF0\u0C77\u0C84\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B60\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E4F\u2E52\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]/;
exports21 = unicodePunctuation;
var _unicodePunctuationRegex = exports21;
var exports$14 = {
};
var unicodePunctuationRegex = _unicodePunctuationRegex;
var regexCheck2 = _regexCheck;
var unicodePunctuation$1 = regexCheck2(unicodePunctuationRegex);
exports$14 = unicodePunctuation$1;
var _unicodePunctuation = exports$14;
var exports22 = {
};
var regexCheck3 = _regexCheck;
var unicodeWhitespace = regexCheck3(/\s/);
exports22 = unicodeWhitespace;
var _unicodeWhitespace = exports22;
var exports23 = {
};
var markdownLineEndingOrSpace1 = _markdownLineEndingOrSpace;
var unicodePunctuation1 = _unicodePunctuation;
var unicodeWhitespace1 = _unicodeWhitespace;
function classifyCharacter(code) {
    if (code === null || markdownLineEndingOrSpace1(code) || unicodeWhitespace1(code)) {
        return 1;
    }
    if (unicodePunctuation1(code)) {
        return 2;
    }
}
exports23 = classifyCharacter;
var _classifyCharacter = exports23;
var exports24 = {
};
var regexCheck4 = _regexCheck;
var asciiAlpha = regexCheck4(/[A-Za-z]/);
exports24 = asciiAlpha;
var _asciiAlpha = exports24;
var exports25 = {
};
function asciiControl(code) {
    return code < 32 || code === 127;
}
exports25 = asciiControl;
var _asciiControl = exports25;
var exports26 = {
};
...
exports26 = whitespaceFactory;
var _factoryWhitespace = exports26;
var exports27 = {
};
...
exports$15.tokenize = tokenize$1;
var exports$2 = {
};
...
exports$4.resolver = resolver;
exports$4.string = string;
exports$4.text = text1;
var exports$5 = {
};
...
exports$5 = serializeChunks;
var _serializeChunks = exports$5;
var exports$6 = {
};
...
exports$6 = sliceChunks;
var _sliceChunks = exports$6;
var exports$7 = {
};
var assign$1 = _assign;
var markdownLineEnding$3 = _markdownLineEnding;
var chunkedPush1 = _chunkedPush;
var chunkedSplice4 = _chunkedSplice;
...
function createTokenizer(parser, initialize, from) {
    ...
    function write(slice) {
        chunks = chunkedPush1(chunks, slice);
        main();
    ...
    function addResult(construct, from1) {
        ...
        if (construct.resolve) {
            chunkedSplice4(context.events, from1, context.events.length - from1, construct.resolve(context.events.slice(from1), context));
        }
...
exports$7 = createTokenizer;
var _createTokenizer = exports$7;
var exports$8 = {
};
        ...
        if (events[index][0] === "enter" && events[index][1].type === "attentionSequence" && events[index][1]._close) {
            ...
            while(open--){
                if (events[open][0] === "exit" && events[open][1].type === "attentionSequence" && events[open][1]._open && context.sliceSerialize(events[open][1]).charCodeAt(0) === context.sliceSerialize(events[index][1]).charCodeAt(0)) {
                    ...
                    nextEvents = chunkedPush$1(nextEvents, resolveAll$1(context.parser.constructs.insideSpan.null, events.slice(open + 1, index), context));
                    nextEvents = chunkedPush$1(nextEvents, [
                        [
                            "exit",
                            text1,
                    ...
                    chunkedSplice$1(events, open - 1, index - open + 3, nextEvents);
...
function tokenizeAutolink(effects, ok, nok) {
    ...
    function urlInside(code) {
        ...
        if (code === 32 || code === 60 || asciiControl1(code)) {
            return nok(code);
        }
        effects.consume(code);
        return urlInside;
...
exports$c = blockQuote1;
var _blockQuote = exports$c;
var exports$d = {
};
var regexCheck$1 = _regexCheck;
var asciiPunctuation = regexCheck$1(/[!-/:-@[-`{-~]/);
exports$d = asciiPunctuation;
var _asciiPunctuation = exports$d;
var exports$e = {
};
...
exports$e = characterEscape;
var _characterEscape = exports$e;
var exports$f = {
};
var regexCheck$2 = _regexCheck;
var asciiDigit = regexCheck$2(/\d/);
exports$f = asciiDigit;
var _asciiDigit = exports$f;
var exports$g = {
};
var regexCheck$3 = _regexCheck;
var asciiHexDigit = regexCheck$3(/[\dA-Fa-f]/);
exports$g = asciiHexDigit;
var _asciiHexDigit = exports$g;
var exports$h = {
};
...
exports$h = characterReference;
var _characterReference = exports$h;
var exports$i = {
};
...
exports$i = codeFenced;
var _codeFenced = exports$i;
var exports$j = {
};
...
function resolveCodeIndented(events, context) {
    ...
    chunkedSplice$2(events, events.length, 0, [
        [
            "exit",
            code,
            context
...
exports$j = codeIndented;
var _codeIndented = exports$j;
var exports$k = {
};
...
exports$l = destinationFactory;
var _factoryDestination = exports$l;
var exports$m = {
};
...
exports$m = labelFactory;
var _factoryLabel = exports$m;
var exports$n = {
};
...
exports$n = titleFactory;
var _factoryTitle = exports$n;
var exports$o = {
};
...
exports$o = definition1;
var _definition = exports$o;
var exports$p = {
};
...
exports$p = hardBreakEscape;
var _hardBreakEscape = exports$p;
var exports$q = {
};
...
function resolveHeadingAtx(events, context) {
    ...
    if (contentEnd > contentStart) {
        ...
        chunkedSplice$3(events, contentStart, contentEnd - contentStart + 1, [
            [
                "enter",
                content2,
                context
...
exports$q = headingAtx;
var _headingAtx = exports$q;
var exports$r = {
};
var basics = [
    "address",
...
function resolveToLabelEnd(events, context) {
    ...
    media = chunkedPush$2(media, events.slice(open + 1, open + offset + 3));
    media = chunkedPush$2(media, [
        [
            "enter",
            text1,
            context
    ...
    media = chunkedPush$2(media, resolveAll$2(context.parser.constructs.insideSpan.null, events.slice(open + offset + 4, close - 3), context));
    media = chunkedPush$2(media, [
        [
            "exit",
            text1,
    ...
    media = chunkedPush$2(media, events.slice(close + 1));
    media = chunkedPush$2(media, [
        [
            "exit",
            group,
    ...
    chunkedSplice$4(events, open, events.length, media);
    return events;
}
...
exports$w = labelStartImage;
var _labelStartImage = exports$w;
var exports$x = {
};
...
exports$x = labelStartLink;
var _labelStartLink = exports$x;
var exports$y = {
};
...
exports$y = lineEnding;
var _lineEnding = exports$y;
var exports$z = {
};
...
exports$z = thematicBreak1;
var _thematicBreak = exports$z;
var exports$A = {
};
...
function tokenizeListContinuation(effects, ok, nok) {
    ...
    function onBlank(code) {
        ...
        return factorySpace$d(effects, ok, "listItemIndent", self.containerState.size + 1)(code);
    }
...
exports$B = setextUnderline;
var _setextUnderline = exports$B;
var exports$C = {
};
Object.defineProperty(exports$C, "__esModule", {
    value: true
});
var text$1 = exports$4;
...
exports$C.contentInitial = contentInitial;
exports$C.disable = disable;
exports$C.document = document;
exports$C.flow = flow;
exports$C.flowInitial = flowInitial;
exports$C.insideSpan = insideSpan;
exports$C.string = string$1;
exports$C.text = text$2;
var exports$D = {
};
var content$2 = exports27;
var document$1 = exports$15;
var flow$1 = exports$3;
var text$3 = exports$4;
var combineExtensions1 = _combineExtensions;
var createTokenizer$1 = _createTokenizer;
var miniflat$11 = _miniflat;
var constructs1 = exports$C;
...
exports28 = preprocess;
var _preprocess = exports28;
var exports29 = {
};
...
exports29 = postprocess;
var _postprocess = exports29;
var exports30 = {
};
var own1 = {
}.hasOwnProperty;
...
var exports$16 = exports30;
var exports31 = {
};
exports31 = fromMarkdown;
...
function compiler(options) {
    ...
    function compile(events) {
        ...
        index1 = -1;
        while((++index1) < config.transforms.length){
            tree = config.transforms[index1](tree) || tree;
        }
        return tree;
    }

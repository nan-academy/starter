...
You're carrier as a rap ghost writer at a dead end as inspiration seems to have
left for good, but you still have an ace up your sleeve, you will write a bot
`PHANT0M-WRiT3R` that find ryhmes for you !

- Log the provided variable `word` if it does not start with `'al'` but end with
  `'ion'`

### Notions

- [startsWith](https://devdocs.io/javascript/global_objects/string/startsWith)
- [endWith](https://devdocs.io/javascript/global_objects/string/endWith)
